...
<template>
  ...
  <div
    ...
    style="background-image: url('/demo/images/8207.jpg'); background-repeat: no-repeat; background-position: center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover"
  >
              ...
              <Card class="card border-1 surface-border">
                <template #header>
                  <div class="flex justify-content-center">
                    <img :src="'http://localhost/RealEstateApi/storage/app/public/' + slotProps.data.image_path" class="border-round w-9 shadow-2 mt-3 mx-0" />
                  </div>
                </template>
                <template #title>
  ...
  <Dialog v-model:visible="productDialog" :breakpoints="{ '1600px': '65vw', '880px': '95vw' }" :style="{ width: '50vw' }" modal :closable="false">
    <div class="grid">
      <div class="col-12 flex align-items-center mt-5 px-5 md:px-8">
        <img :src="'http://localhost/RealEstateApi/storage/app/public/' + product.image_path" alt="" class="shadow-8 w-full border-round-3xl"/>
      </div>
